...
public class OperationPlayVideo : MonoBehaviour
{
	...
	public void OnGUI()
	{
		...
		if (_visible)
		{
			...
			GUILayout.BeginArea(new Rect((Screen.width-740)/2, 30, 740, 330), GUI.skin.box);
			ControlWindow(0);
			GUILayout.EndArea();
		}
		GUI.color = new Color(1f, 1f, 1f, 1f - _alpha);
		GUI.Box(new Rect((Screen.width-128)/2, 30, 128, 32), "Pengaturan Video");
	}
	
	void Update()
	{
		Rect r = new Rect((Screen.width-740)/2, 30, 740, 330);
