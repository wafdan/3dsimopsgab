...
//[DoNotSerialize]
public class TankUnitMovement : BasicUnitMovement
{
    ...
    public override bool IsPointingAtTarget(Vector3 target)
    {
        ...
        {
            Vector3 barrelForwardDir = -barrel.transform.up;//harusnya forward, tapi right yg dipake karena mungkin kesalahan di modeling.
